                            ...
                            <div class="nk-block-head nk-block-head-sm">
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        <h3 class="nk-block-title page-title">Siswa Didik {{ $row->guru->nm_guru }} Kelas
                                            {{ $row->tingkat }}</h3>
                                                ...
                                                <ul class="nk-block-tools g-3">
                                                    ...
                                                    @if (auth()->user()->akses == 'wali')
                                                        <li class="nk-block-tools-opt d-none d-sm-block">
                                                            <a href="{{ route('catatan.create') }}" class="btn btn-primary"><em
                            ...
                            <div class="nk-block">
                                <div class="row g-gs">
                                    @foreach ($siswa as $item)
                                        @php
                                            $catatan = catatan::where('kd_siswa', $item->kd_siswa)
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        ...
                                                                        @if (auth()->user()->akses == 'wali')
                                                                            <li><a
                                                                                    href="{{ route('catatan.create') }}?siswa={{ $item->kd_siswa }}"><em
                                                                        ...
                                                                        @foreach ($catatan as $el)
                                                                            <tr>
                                                                                ...
                                                                                @if (auth()->user()->akses == 'wali')
                                                                                    <td>
                                                                                        <a
                                                                                            href="{{ route('catatan.edit', $el->kd_cat) }}">edit</a>
                                                                                        <a href="{{ route('catatan.destroy', $el->kd_cat) }}"
                                                                                            onclick="event.preventDefault(); document.getElementById('form-delete{{ $loop->iteration }}').submit()">hapus</a>
                                                                                        <form
                                                                                            action="{{ route('catatan.destroy', $el->kd_cat) }}"
