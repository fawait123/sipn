            ...
            <div class="container-fluid">
                <div class="nk-content-inner">
                    <div class="nk-content-body">
                        <div class="nk-block-head nk-block-head-sm">
                            <div class="nk-block-between">
                                <div class="nk-block-head-content">
                                    <h3 class="nk-block-title page-title">Matapelajaran {{ $guru->nm_guru }}</h3>
                                    <div class="nk-block-des text-soft">
                                        <p>Kamu mempunyai {{ count($guru->gurumapel) }} matapelajaran yang di ampuh</p>
                                    </div>
                        ...
                        <div class="nk-block">
                            <div class="row g-gs">
                                @foreach ($guru->gurumapel as $item)
                                            ...
                                            <div class="card-inner">
                                                <div class="project">
                                                    ...
                                                    <div class="project-details">
                                                        <p>{{ $guru->nm_guru }} kamu mengampuh {{ $item->mapel->nm_mapel }} di
                                                            tingkat
                                                            {{ $item->tingkat }}</p>
                                                    </div>
