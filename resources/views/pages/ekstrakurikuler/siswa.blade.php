                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        ...
                                                                        @if (auth()->user()->akses == 'wali')
                                                                            <li><a
                                                                                    href="{{ route('ekstrakurikuler.create') }}?siswa={{ $item->kd_siswa }}"><em
                                                                        ...
                                                                        @foreach ($ekstrakurikuler as $el)
                                                                            <tr>
                                                                                ...
                                                                                @if (auth()->user()->akses == 'wali')
                                                                                    <td>
                                                                                        <a
                                                                                            href="{{ route('ekstrakurikuler.edit', $el->kd_nekskul) }}">edit</a>
                                                                                        <a href="{{ route('ekstrakurikuler.destroy', $el->kd_nekskul) }}"
                                                                                            onclick="event.preventDefault(); document.getElementById('form-delete{{ $loop->iteration }}').submit()">hapus</a>
                                                                                        <form
                                                                                            action="{{ route('ekstrakurikuler.destroy', $el->kd_nekskul) }}"
