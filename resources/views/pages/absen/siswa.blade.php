                                                ...
                                                <ul class="nk-block-tools g-3">
                                                    ...
                                                    @if (auth()->user()->akses == 'wali')
                                                        <li class="nk-block-tools-opt d-none d-sm-block">
                                                            <a href="{{ route('absen.create') }}" class="btn btn-primary"><em
                            ...
                            <div class="nk-block">
                                <div class="row g-gs">
                                    @foreach ($siswa as $item)
                                        @php
                                            $absen = absen::where('kd_siswa', $item->kd_siswa)
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        ...
                                                                        @if (auth()->user()->akses == 'wali')
                                                                            <li><a
                                                                                    href="{{ route('absen.create') }}?siswa={{ $item->kd_siswa }}"><em
                                                                        ...
                                                                        @foreach ($absen as $el)
                                                                            <tr>
                                                                                ...
                                                                                @if (auth()->user()->akses == 'wali')
                                                                                    <td>
                                                                                        <a
                                                                                            href="{{ route('absen.edit', $el->kd_nabsen) }}">edit</a>
                                                                                        <a href="{{ route('absen.destroy', $el->kd_nabsen) }}"
                                                                                            onclick="event.preventDefault(); document.getElementById('form-delete{{ $loop->iteration }}').submit()">hapus</a>
                                                                                        <form
                                                                                            action="{{ route('absen.destroy', $el->kd_nabsen) }}"
