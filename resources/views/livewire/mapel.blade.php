                            ...
                            <div class="card-inner p-0">
                                <div class="nk-tb-list">
                                    <div class="nk-tb-item nk-tb-head">
                                        <div class="nk-tb-col"><span>Kode Mapel</span></div>
                                        <div class="nk-tb-col"><span>Nama Mapel</span></div>
                                        <div class="nk-tb-col"><span>Kompetensi</span></div>
                                        <div class="nk-tb-col"><span>Tingkat</span></div>
                                        <div class="nk-tb-col"><span>Kelompok</span></div>
                                        <div class="nk-tb-col"><span>Kb Keterampilan</span></div>
                                        <div class="nk-tb-col"><span>Kb Pengetahuan</span></div>
                                    ...
                                    @if (count($query) > 0)
                                        @foreach ($query as $item)
                                            <div class="nk-tb-item">
                                                <div class="nk-tb-col">
                                                    <span class="tb-sub">{{ $item->kd_mapel }}</span>
                                                </div>
                                                <div class="nk-tb-col">
                                                    <span class="tb-lead">{{ $item->nm_mapel }}</span>
                                                </div>
                                                <div class="nk-tb-col">
                                                    <span class="tb-sub">{{ $item->kompetensi }}</span>
                                                </div>
                                                <div class="nk-tb-col">
                                                    <span class="tb-sub">{{ $item->tingkat }}</span>
                                                </div>
                                                <div class="nk-tb-col">
                                                    <span class="tb-sub">{{ $item->kelompok }}</span>
                                                </div>
                                                <div class="nk-tb-col">
                                                    <span class="tb-sub">{{ $item->kb_keterampilan }}</span>
                                                </div>
                                                <div class="nk-tb-col">
                                                    <span class="tb-sub">{{ $item->kb_pengetahuan }}</span>
                                                </div>
                                                        ...
                                                        <li class="me-n1">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a
                                                                                href="{{ route('mapel.edit', $item->kd_mapel) }}"><em
                                                                        ...
                                                                        <li><a href="#"><em
                                                                                    ...
                                                                                    Orders</span></a></li> --}}
                                                                        <li><a href="{{ route('mapel.destroy', $item->kd_mapel) }}"
                                                                        ...
                                                                        <form
                                                                            action="{{ route('mapel.destroy', $item->kd_mapel) }}"
