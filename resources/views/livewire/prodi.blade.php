                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Prodi</h3>
                            ...
                            <div class="card-inner p-0">
                                <div class="nk-tb-list">
                                    <div class="nk-tb-item nk-tb-head">
                                        <div class="nk-tb-col"><span>Kode prodi</span></div>
                                    ...
                                    @if (count($query) > 0)
                                        @foreach ($query as $item)
                                            <div class="nk-tb-item">
                                                <div class="nk-tb-col">
                                                    <span class="tb-sub">{{ $item->kd_prodi }}</span>
                                                </div>
                                                <div class="nk-tb-col">
                                                        ...
                                                        <li class="me-n1">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a
                                                                                href="{{ route('prodi.edit', $item->kd_prodi) }}"><em
                                                                        ...
                                                                        <li><a href="#"><em
                                                                                    ...
                                                                                    Orders</span></a></li> --}}
                                                                        <li><a href="{{ route('prodi.destroy', $item->kd_prodi) }}"
                                                                        ...
                                                                        <form
                                                                            action="{{ route('prodi.destroy', $item->kd_prodi) }}"
