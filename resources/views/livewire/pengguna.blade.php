                            ...
                            <div class="card-inner p-0">
                                <div class="nk-tb-list">
                                    <div class="nk-tb-item nk-tb-head">
                                        <div class="nk-tb-col"><span>Kode pengguna</span></div>
                                        <div class="nk-tb-col"><span>Nama pengguna</span></div>
                                        <div class="nk-tb-col"><span>Akses</span></div>
                                    ...
                                    @if (count($query) > 0)
                                        @foreach ($query as $item)
                                            <div class="nk-tb-item">
                                                <div class="nk-tb-col">
                                                    <span class="tb-sub">{{ $item->kd_pengguna }}</span>
                                                </div>
                                                <div class="nk-tb-col">
                                                    <span class="tb-sub">{{ $item->nm_pengguna }}</span>
                                                </div>
                                                <div class="nk-tb-col">
                                                    <span class="tb-sub">{{ $item->akses }}</span>
                                                </div>
                                                <div class="nk-tb-col">
                                                    <span
                                                        class="tb-sub">{{ $item->aktif == 1 ? 'Aktif' : 'Tidak Aktif' }}</span>
                                                </div>
                                                        ...
                                                        <li class="me-n1">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a
                                                                                href="{{ route('pengguna.edit', $item->kd_pengguna) }}"><em
                                                                        ...
                                                                        <li><a href="#"><em
                                                                                    ...
                                                                                    Orders</span></a></li> --}}
                                                                        <li><a href="{{ route('pengguna.destroy', $item->kd_pengguna) }}"
                                                                        ...
                                                                        <form
                                                                            action="{{ route('pengguna.destroy', $item->kd_pengguna) }}"
